...
// For production: Set VITE_API_URL to your backend URL (e.g., https://nutritrack-2dkn.onrender.com/api)
// For local development: Use http://localhost:4000/api
// NEVER set to 'demo' in production - it will use mock data!
const API_URL = import.meta.env.VITE_API_URL || 'http://localhost:4000/api';
const IS_DEMO_MODE = import.meta.env.VITE_API_URL === 'demo' || !import.meta.env.VITE_API_URL;
